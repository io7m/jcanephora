...
public class IndexBufferMapLWJGL30Test
{
  ...
  @SuppressWarnings("static-method") @Test public void testReadWriteByte()
    throws GLException,
      ConstraintError,
      IOException
  {
  ...
  @SuppressWarnings("static-method") @Test public void testReadWriteInt()
    throws GLException,
      ConstraintError,
      IOException
  {
  ...
  @SuppressWarnings("static-method") @Test public void testReadWriteShort()
    throws GLException,
      ConstraintError,
      IOException
  {
