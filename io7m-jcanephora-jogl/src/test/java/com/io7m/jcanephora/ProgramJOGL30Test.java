...
public class ProgramJOGL30Test
{
  ...
  @SuppressWarnings("static-method") @Test public
    void
    testProgramAddFragmentShaderNonexistent()
      throws IOException,
        ConstraintError
  {
    final Program p = new Program("program", ProgramJOGL30Test.getLog());
    ...
    final Program p = new Program("program", ProgramJOGL30Test.getLog());
    {
      final boolean r =
        p.requiresCompilation(
          ProgramJOGL30Test.getFS(),
          GLInterfaceJOGL30Util.getGL(this.context));
      ...
      GLException
  {
    ...
    final Filesystem fs = ProgramJOGL30Test.getFS();
  ...
  @SuppressWarnings("static-method") @Test public
    void
    testProgramAddFragmentShaderTwice()
      throws IOException,
        ConstraintError
  {
    final Program p = new Program("program", ProgramJOGL30Test.getLog());
  ...
  @SuppressWarnings("static-method") @Test public
    void
    testProgramAddVertexShaderNonexistent()
      throws IOException,
        ConstraintError
  {
    final Program p = new Program("program", ProgramJOGL30Test.getLog());
  ...
  @SuppressWarnings("static-method") @Test public
    void
    testProgramAddVertexShaderTwice()
      throws IOException,
        ConstraintError
  {
    final Program p = new Program("program", ProgramJOGL30Test.getLog());
      ...
      GLException
  {
    ...
    final Program p = new Program("program", ProgramJOGL30Test.getLog());
    p.addFragmentShader(new PathVirtual("/shaders/simple.f"));
    p.compile(fs, GLInterfaceJOGL30Util.getGL(this.context));
    Assert.assertFalse(p.requiresCompilation(
      fs,
      GLInterfaceJOGL30Util.getGL(this.context)));
    p.delete(GLInterfaceJOGL30Util.getGL(this.context));
  }
  ...
  {
    final Program p = new Program("program", ProgramJOGL30Test.getLog());
    p.deactivate(GLInterfaceJOGL30Util.getGL(this.context));
  }
  ...
  @SuppressWarnings("static-method") @Test public
    void
    testProgramNotCompiledAttribute()
      throws IOException,
        ConstraintError
  {
    final Program p = new Program("program", ProgramJOGL30Test.getLog());
