...
@NotThreadSafe class GLEmbeddedJOGLES2Actual implements GLInterfaceEmbedded
{
  /**
  ...
  public GLEmbeddedJOGLES2Actual(
      ...
      GLException
  {
    ...
    this.integer_cache_buffer =
      ByteBuffer
        .allocateDirect(GLEmbeddedJOGLES2Actual.INTEGER_CACHE_SIZE)
      ...
      ConstraintError
  {
    ...
    final int type =
      GLEmbeddedJOGLES2Actual.scalarTypeToGL(buffer_attribute.getType());
      ...
      ConstraintError
  {
    ...
    final GL2ES2 g = this.contextGetGL();
  ...
  @Override public final void blendingEnableSeparateWithEquationSeparate(
    final @Nonnull BlendFunction source_rgb_factor,
    final @Nonnull BlendFunction source_alpha_factor,
    final @Nonnull BlendFunction destination_rgb_factor,
    final @Nonnull BlendFunction destination_alpha_factor,
      ...
      GLException
  {
    ...
    gl.glBlendEquationSeparate(
      GLEmbeddedJOGLES2Actual.blendEquationToGL(equation_rgb),
      GLEmbeddedJOGLES2Actual.blendEquationToGL(equation_alpha));
    gl.glBlendFuncSeparate(
      GLEmbeddedJOGLES2Actual.blendFunctionToGL(source_rgb_factor),
      GLEmbeddedJOGLES2Actual.blendFunctionToGL(destination_rgb_factor),
      GLEmbeddedJOGLES2Actual.blendFunctionToGL(source_alpha_factor),
      GLEmbeddedJOGLES2Actual.blendFunctionToGL(destination_alpha_factor));
    GLError.check(this);
  }

  @Override public final void blendingEnableWithEquation(
    final @Nonnull BlendFunction source_factor,
    final @Nonnull BlendFunction destination_factor,
  ...
  @Override public final void blendingEnableWithEquationSeparate(
    final @Nonnull BlendFunction source_factor,
    final @Nonnull BlendFunction destination_factor,
    final @Nonnull BlendEquation equation_rgb,
    final @Nonnull BlendEquation equation_alpha)
      ...
      GLException
  {
    ...
    final int fi = GLEmbeddedJOGLES2Actual.faceSelectionToGL(faces);
    final int oi = GLEmbeddedJOGLES2Actual.faceWindingOrderToGL(order);
      ...
      GLException
  {
    ...
    final int d = GLEmbeddedJOGLES2Actual.depthFunctionToGL(function);
      ...
      GLException
  {
    ...
    final int mode_gl = GLEmbeddedJOGLES2Actual.primitiveToGL(mode);
    final int type =
      GLEmbeddedJOGLES2Actual.unsignedTypeToGL(indices.getType());
      ...
      GLException
  {
    ...
    GLEmbeddedJOGLES2Actual.shaderReadSource(stream, lines, lengths);
      ...
      GLException
  {
    ...
    for (int index = 0; index < max; ++index) {
      ...
      final GLType.Type type = GLEmbeddedJOGLES2Actual.typeFromGL(type_raw);
  ...
  @Override public final int stencilBufferGetBits()
    throws GLException
  {
    final GL2GL3 gl = this.contextGetGL();
      ...
      ConstraintError
  {
    ...
    g.glBindBuffer(GL.GL_ELEMENT_ARRAY_BUFFER, buffer.getLocation());
    g.glBufferSubData(
      GL.GL_ELEMENT_ARRAY_BUFFER,
      data.getTargetDataOffset(),
      data.getTargetDataSize(),
