...
public final class ShaderPaths
{
  ...
  static {
    try {
      GLSL_40_SHADER_PATH =
        PathVirtual.ofString("/com/io7m/jcanephora/shaders/glsl40");
      GLSL_130_SHADER_PATH =
        PathVirtual.ofString("/com/io7m/jcanephora/shaders/glsl130");
      GLSL_110_SHADER_PATH =
        PathVirtual.ofString("/com/io7m/jcanephora/shaders/glsl110");
      GLSL_ES_100_SHADER_PATH =
        PathVirtual.ofString("/com/io7m/jcanephora/shaders/glsles100");
