...
public class TextureTypeTest
{
  @SuppressWarnings("static-method") @Test public void testBytesPerPixel()
  {
    Assert.assertEquals(
      1,
      TextureTypeMeta.bytesPerPixel(TextureType.TEXTURE_TYPE_ALPHA_8_1BPP));
    Assert.assertEquals(2, TextureTypeMeta
      .bytesPerPixel(TextureType.TEXTURE_TYPE_LUMINANCE_ALPHA_88_2BPP));
    Assert.assertEquals(
      2,
